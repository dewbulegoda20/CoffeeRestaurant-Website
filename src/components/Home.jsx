    ...
    return (
        <div className=" min-h-screen flex flex-col justify-center lg:flex-row lg:justify-between items-center lg:px-32 px-5 gap-10 bg-gradient-to-r from-[#FFDCAB] to-[#AB6B2E]">
            <div className=" w-full lg:w-2/4 space-y-4 mt-14 lg:mt-0">
                ...
                <p>Boost your productivity and build your mood with a glass of a coffee in the morning</p>
            ...
            <div className="relative">
                ...
                <div className=" absolute bg-white px-8 py-2 top-28 right-10 rounded-full shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)]">
                    <h2 className=" font-semibold">14k</h2>
                </div>

                <div className=" absolute bg-white px-8 py-2 bottom-16 -left-0 rounded-full">
                    <h2>Cappuccino</h2>
                </div>
            </div>
