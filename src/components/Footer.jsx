        ...
        <div className=" bg-gradient-to-r from-[#FFDCAB] to-[#AB6B2E] text-black rounded-t-3xl mt-8 md:mt-0">
            <div className=" flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
                <div className=" w-full md:w-1/4">
                    ...
                    <p className=" text-sm">Welcome to our coffee haven! Explore our aromatic brews, Savor
                ...
                <div>
                    ...
                    <nav className=" flex flex-col gap-2">
                        ...
                        <a className="hover:text-backgroundColor transition-all cursor-pointer" href="/"> 0112 564 234 </a>
