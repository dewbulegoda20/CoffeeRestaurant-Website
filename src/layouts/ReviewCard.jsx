...
const ReviewCard = (props) => {
    return (
        <div className=" flex flex-col w-full lg:w-2/6 bg-white p-3 rounded-lg gap-5">
            ...
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantum ab
                et optio labore perferendis saepe. Fuga, deleniti! Laudantium eos
                delectus cumque repudiandae ut deserunt id?
            </p>
        </div>
    );
};
